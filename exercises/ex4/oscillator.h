...
public:
  ...
  // ustawianie wsk. do prawego
  void set_2nd_left(std::shared_ptr<oscillator> l);
  // ustawianie wsk. do lewego
  void set_3rd_right(std::shared_ptr<oscillator> r);
  // ustawianie wsk. do prawego
  void set_3rd_left(std::shared_ptr<oscillator> l);
  // ustawianie wsk. do lewego
